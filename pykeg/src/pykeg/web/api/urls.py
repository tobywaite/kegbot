...
urlpatterns = patterns('pykeg.web.api.views',
    ...
    url(r'^kegs/?$', 'all_kegs'),
    url(r'^kegs/active?$', 'get_active_kegs'),
    url(r'^kegs/purchased?$', 'get_purchased_kegs'),
    url(r'^kegs/ondeck?$', 'get_ondeck_kegs'),
    ...
    url(r'^kegs/update/(?P<keg_id>\d+)/?$', 'update_keg_status'),
    url(r'^login/?$', 'login'),
    url(r'^logout/?$', 'logout'),
    url(r'^request_keg/?$', 'submit_keg_request'),
    url(r'^taps/?$', 'all_taps'),
