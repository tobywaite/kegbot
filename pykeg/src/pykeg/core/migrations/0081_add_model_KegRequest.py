...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KegRequest'
        db.create_table('core_kegrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seqn', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='keg_request', null=True, to=orm['auth.User'])),
            ('keg', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='keg_request', null=True, to=orm['core.Keg'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('core', ['KegRequest'])


    def backwards(self, orm):
        # Deleting model 'KegRequest'
        db.delete_table('core_kegrequest')
    ...
    models = {
        ...
        'core.kegrequest': {
            'Meta': {'object_name': 'KegRequest'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keg': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'keg_request'", 'null': 'True', 'to': "orm['core.Keg']"}),
            'seqn': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'time': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'keg_request'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        ...
        'core.userprofile': {
            ...
            'api_secret': ('django.db.models.fields.CharField', [], {'default': "'f79b9d26f12119f3ee7c8cde90bc29fc'", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
